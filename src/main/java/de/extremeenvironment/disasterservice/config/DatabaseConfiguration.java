...
import de.extremeenvironment.disasterservice.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("de.extremeenvironment.disasterservice.repository")
