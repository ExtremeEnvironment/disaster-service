...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "DisasterService@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "DisasterService API";

        private String description = "DisasterService API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "DisasterService";
