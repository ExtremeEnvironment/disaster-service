package de.extremeenvironment.disasterservice;
...
@EnableEurekaClient
public class DisasterServiceApp {

    private static final Logger log = LoggerFactory.getLogger(DisasterServiceApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes DisasterService.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DisasterServiceApp.class);
